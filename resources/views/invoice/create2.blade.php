    ...
    <form method="POST" action="{{ route('storeInvoice') }}">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-5 invoice-address-client">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label col-form-label-sm">اسم الشركة / اسم الشخص</label>
                    <div class="col-sm-9">
                ...
                <div class="invoice-address-client-fields">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" style="width: 359px" class="form-control form-control-sm text-center" name="receiverId"
                    ...
                    <div class="form-group row invoice-created-by">
                        ...
                        <div class="col-sm-9">
                            <select name="taxpayerActivityCode" class="form-control form-control-sm">
                                <option value="1312" style="font-size: 20px">نسج المنسوجات</option>
                                <option value="1410" style="font-size: 20px">صناعة الملابس ذات الزينة باستثناء الفراء
                                </option>
                            </select>
                        </div>
                    </div>
        ...
        <div id="newOne">
            ...
            <table style="margin: auto" border="1">
                ...
                <tr>
                    ...
                    <td>
                        <select name="t4subtype[]" id="t4subtype" class="form-control form-control-sm ">
                            @foreach ($t4tax as $subtype)
                                <option value="{{ $subtype->code }}">{{ $subtype->name_ar }}</option>
                            @endforeach
                        </select>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td colspan="4"><input type="number" step="any" name="totalItemsDiscount[]" readonly
        ...
        <div style="text-align: center;margin: auto">
            ...
            <button type="button" class="rounded-sm btn btn-info" id="addNewOne" style="width: 200px"> إضافة صنف</button>
        </div>
                    ...
                    <table style="margin: auto" border="1">
                        ...
                        <tr>
                            ...
                            <td>
                             ...
                             <td>
                        <select name="t4subtype[]" id="t4subtype" class="form-control form-control-sm basic">
                            @foreach ($t4tax as $subtype)
                                <option value="{{ $subtype->code }}">{{ $subtype->name_ar }}</option>
                            @endforeach
                        </select>
                        ...
                        <tr>
                            <td> <input type="number" step="any" name="t2Amount[]" readonly id="t2${i}" {{-- onkeyup="t2value(this.value)" onmouseover="t2value(this.value)" --}}>
                            </td>
