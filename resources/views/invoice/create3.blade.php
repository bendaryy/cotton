                ...
                @foreach ($companies as $item)
                 ...
                 <div class="form-group row invoice-created-by">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{ $item->AddrCo }}"
                                    class="text-center form-control form-control-sm" name="street"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" value="{{ date('Y-m-d') }}"
                                    class="text-center form-control form-control-sm" name="date" placeholder="">
                            </div>
                        </div>
                    </div>
